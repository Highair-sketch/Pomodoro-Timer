...
def count_down(count):
    count_min = math.floor(count / 60)  # number of min
    count_sec = count % 60  # num of sec
    if count_sec == 0:
        count_sec = '00'
...
# reset button
start_button = Button(text='Reset', bg=YELLOW, highlightthickness=0, command=reset_timer)
start_button.grid(column=2, row=2)

# number of tomato session done
